...
public class EventEarningsDTO {
    ...
    public EventEarningsDTO() {
    }

    public EventEarningsDTO(Long eventId, String name, long totalBookings, double totalRevenue, double averageBookingAmount) {
    ...
    public static final class Builder {
        ...
        public EventEarningsDTO build() {
            return new EventEarningsDTO(eventId, name, totalBookings, totalRevenue, averageBookingAmount);
        }
    }
}
